...
const AdminPanel = () => {
  ...
  return (
    <div className="bg-gray-100 min-h-screen p-8">
      ...
      <div className="bg-white rounded shadow text-left overflow-hidden mb-6">
        <div className="p-4 border-b flex flex-col md:flex-row md:items-center justify-between gap-4">
          ...
          <div className="flex flex-wrap gap-3">
             <input 
                ...
                className="border rounded px-3 py-1 text-sm bg-gray-50 focus:bg-white"
                value={emailFilter}
                onChange={handleFilterChange(setEmailFilter)}
             />
             <select 
             ...
             <select 
                className="border rounded px-3 py-1 text-sm bg-gray-50 font-medium"
                value={sortBy}
            ...
            <div className="overflow-x-auto">
              <table className="min-w-full divide-y divide-gray-200">
                ...
                <tbody className="bg-white divide-y divide-gray-200">
                  {users?.length === 0 ? (
                    <tr>
                      <td colSpan="4" className="px-6 py-8 text-center text-gray-500 italic">No users found matching your filters.</td>
                    </tr>
                  ) : (
                    users?.map((user) => (
                      <tr key={user._id}>
